...
\begin{jrsection}{Projects}
    \jproject{
        ...
        \begin{jrdescription}
            ...
            since June 2018 as the chief architect.\ In fact, I have a crucial role in designing architecture model and implementing several infrastructural APIs.\ I also
    ...
    \jproject{
        ...
        \begin{jrdescription}
            ...
            as a key member of the architecture team.\ The team had a crucial role in the project and had some important tasks such as designing architecture model and
            implementing a framework that is used by other developers to reduce implementation time.\ In fact, I had a crucial role in designing the architecture model and
    ...
    \jproject{
        ...
        \begin{jrdescription}
            ...
            as a key member of the Lending team which deals with loans, bank guarantees, and collateral.\ In fact, I had a crucial role in designing and implementing
            ...
            cooperated in infrastructural components related to the lending system.\ It is valuable to mention that Lotus project has been operational in
