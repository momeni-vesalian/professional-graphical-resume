...
\begin{jrsection}{Work Experience}
    \jexperience{
        ...
        \begin{jrdescription}
            ...
            - I design the architecture model and implement architectural APIs.\linebreak
            - I design and implement the matching engine.\linebreak
        \end{jrdescription}
    }
    \jexperience{
    ...
    \jexperience{
        ...
        \begin{jrdescription}
            - I worked as a member of the Media Observatory team.\linebreak
